...
public class Lista_contenido {
     ...
     */
    public static ArrayList<Peliculax> ENTRADAS_LISTA = new ArrayList<Peliculax>();

    /**
     * Donde se asigna el identificador a cada entrada de la lista
     */
    public static Map<String, Peliculax> ENTRADAS_LISTA_HASHMAP = new HashMap<String, Peliculax>();
     ...
     */
    static {
        aniadirEntrada(new Peliculax("1", "RESERVOIR DOGS", "1992", "CASTING:\n" + "\n" +
                ...
                "\n" +
                "CURIOSIDADES:\n" + "\n" +
                "ºº En la escena de tortura del policía, Tarantino dejó al actor dos horas ahí atado para que se metiera en el personaje. Las cuerdas estaban muy apretadas para dar realismo.\n" +
                "\n" +
                "ºº Durante todo el rodaje estuvo presente un paramédico, para asegurarse que la cantidad de sangre del Sr. Naranja se mantuviera en cantidades creíbles.\n" +
                "\n" +
                "ºº Uno de los grandes misterios del cine de Tarantino es el apellido Vega. En Reservoir Dogs sabemos que el Sr. Rubio se llama Vic Vega pero lo curioso es que en la siguiente película del director, Pulp Fiction, John Travolta interpreta a un asesino llamado Vincent Vega. \n" +
                "Conociendo la afición de Tarantino por hacerse honores no sorprendería que hubiese una unión entre estos dos personajes.\n" +
                "\n" +
                "ºº Durante la película se dice 252 veces la palabra \"Fuck\". Aun así, varios sitios web amplían o reducen la cifra, que siempre sitúa alrededor de este número.\n", "drawable/rsbb2", R.drawable.rsbb2, R.drawable.reservdogscaptura));
        aniadirEntrada(new Peliculax("2","PULP FICTION","1994","CASTING:\n" +"\n" +
                ...
                "\n" +
                "ºº La famosa cartea de Jules era, también, de Tarantino\n" +"\n"+
                "ºº La famosa cartera con el Bad Motherfucker escrito sobre ella pertenecía también al director y se la prestó para la escena.\n" +
                "\n" +
                "ºº Christopher Walken no ensayó su escena, y utilizó Tabasco para rodarla.\n" +
        ...
        aniadirEntrada(new Peliculax("3","JACKIE BROWN","1997","CASTING:\n" +"\n" +"# Pam Grier - Jackie Brown\n" +
                ...
                "\n" +
                "CURIOSIDADES:\n" +"\n" +
                "ºº El papel de Jackie Brown estaba escrito específicamente para Pam Grier. Cuando Quentin leyó por primera vez el libro \"Rum Punch\", en el que se basa el film, se pasó la parte en la que Jackie es descrita como una mujer blanca. Sólo se dió cuenta cuando adaptó el guión y tuvo que revisar el libro.\n" +
                "\n" +
                "ºº Quentin cambió enl nombre original de la novela \"Rum Punch\" (Jackie Burke) por el de Jackie Brown en honor a la película Foxy Brown.\n" +
                "\n" +
                "ºº El nombre de Jackie Brown fue sacado de una criminal caracteriazada en la novela de 1973, \"The Friends of Eddie Coyle\" de George V. Higgins.\n" +
                "\n" +
                "ºº La productora \"Mighty Mighty Afrodite\" que colabora en Jackie Brown, pertenece a la ex-novia de Quentin, Mira Sorvino.\n","drawable/jbbb",R.drawable.jbbb,R.drawable.jackcaptura));

        aniadirEntrada(new Peliculax("4","KILL BILL VOL.1","2003","CASTING:\n" +"\n" +"# Uma Thurman - Beatrix Kiddo \n" +
                ...
                "CURIOSIDADES:\n" +
                "\n" +
                "º Cuando Beatrix Kiddo llega a Tokio, se escucha la canción “El vuelo del abejorro“, tema principal de la serie “El avispón verde”, donde Bruce Lee interpretó a Kato.\n" +
                "\n" +
                "º Sonny Chiba, actor que le dio vida a Hattori Hanzo, hace katanas en la vida real. También interpretó al mismo personaje en la serie de televisión “Kage no Gundam”. El hombre es icono del cine de artes marciales de los 70.\n" +"\n" +
                "º El nombre Hattori Hanzo también sale en la serie “Shadow Warriors” y hasta en el videojuego “Samurai Shodown“.\n" +"\n" +
                "º Se ocuparon más de 500 litros de sangre falsa para rodar Kill Bill Vol. 1 y Kill Bill Vol. 2. ¿Por qué hay dos partesx?x Nunca estuvo pensado así, pero Tarantino la dividió entendiendo que estar 4 horas en el cine es para quedar enfermo.\n","drawable/kbbb",R.drawable.kbbb,R.drawable.killbillcaptura));

        aniadirEntrada(new Peliculax("5","KILL BILL VOL.2","2004","CASTING:\n" +"# Uma Thurman - Beatrix Kiddo\n" +
                ...
                "\n" +
                "CURIOSIDADES:\n" +
                "ºº Quentin Tarantino, como en todos sus filmes aparece en la película. Es uno de los 88 maníacos que luchan contra la novia en el restaurante de Tokyo. Debido al antifaz y a la cantidad de luchadores, es difícil identificarlo. \n" +
                "\n" +
                "ºº La marca de cigarrillos Red Apple, es una marca ficticia que Quentin Tarantino utiliza para todas sus películas, además, se puede observar que el dibujo de la portada de los paquetes es una manzana roja de la que sale un gusano verde con la cara del mismo director con gafas de sol. \n" +
                "\n" +
                "ºº El rodaje se inició el 14 de junio de 2002 en Pekín, con bastante retraso debido al embarazo de Uma Thurman, y se prolongó hasta el 3 de marzo de 2003. \n" +
                "\n" +
                "ºº La escena de la pelea contra los 88 maniacos es una calca de la coreografia de una de las peleas de \"puños de furia\", de igual forma, el traje que usa la novia en esta escena, y la trama (la lista), es un guiño a \"el juego con la muerte\" ambas de Bruce Lee.\n","drawable/kbb2",R.drawable.kbb2,R.drawable.killbill2captura2));

        aniadirEntrada(new Peliculax("6","DEATH PROOF","2007","CASTING:\n" +"\n" +"# Kurt Russell - Especialista Mike/Doble Mike\n" +
                ...
                "CURIOSIDADES:\n" +
                "\n" +
                "ºº Tarantino vuelve a recurrir en 'Death Proof' a varios elementos comunes de sus películas anteriores: uno de los personajes pide cigarrillos 'Red Apple' (que aparecen en casi todas sus películas), y Especialista Mike menciona la famosa hamburguesa 'Big Kahuna' que tan popular hizo Samuel L. Jackson en 'Pulp Fiction'.\n" +
                "\n" +
                "ºº Por todos es conocido el mimo con el que Tarantino selecciona la banda sonora de sus películas. Lo que quizá no conocías es que la gramola que aparece en 'Death Proof' pertenece a su colección personal, se llama AMi, y también apareció en la película 'Asesinos natos', de la que Tarantino fue guionista.\n" +
                "\n" +
                "ºº 'Death Proof' ha sido, hasta la fecha, la única película en la que Quentin Tarantino no se ha servido del recurso del flashback o de los saltos en el tiempo para narrar la historia, por lo que podemos ver todo lo que ocurre en orden cronológico.\n" +
                "\n" +
                "ºº Tarantino suele ser conocido por no dejar nada al azar en cada uno de los detalles de sus películas. " +
                "Y las matrículas de los dos coches utilizados por Especialista Mike no iban a ser una excepción. La matrícula JJZ-109 es un tributo a la matrícula de Steve McQueen en 'Bullitt', y la matrícula 983-DAN aparecía en la película 'La indecente Mary y Larry el loco'.\n","drawable/dprbb",R.drawable.dprbb,R.drawable.deathcaptura));

        aniadirEntrada(new Peliculax("7","INGLORIUS BASTARDS","2009","CASTING:\n" +"\n" +
                ...
                "CURIOSIDADES:\n" +
                "\n" +
                "ºº Eli Roth ganó 15 kilos de músculo para interpretar a Donnie Donowitz, \"el Oso Judío\". Roth también aprendió a cortar el pelo para el papel gracias a Humberto, el padre de la productora Pilar Savone, en su salón de Beverly Hills.\n" +
                "\n" +
                "ºº Quentin Tarantino empezó a escribir el guión antes de Kill Bill: Volume 1, pero no se le ocurría ningún buen final, así que lo pausó y empezó a rodar Kill Bill, un proyecto que había estado preparando mentalmente desde Pulp Fiction (1994).\n" +
                "\n" +
                "ºº Quentin Tarantino quería hacer una película de guerra con el estilo del spaghetti western, así, decidió que el título sería \"Érase una vez en la Francia ocupada\". Finalmente lo desestimó, pero dio ese nombre al título del primer capítulo de la película.\n" +
                "\n" +
                "ºº La directora de casting Johanna Ray que trabajó en Kill Bill y en Malditos Bastardos," +
                " estuvo casada con Aldo Ray de 1960 a 1967.\n","drawable/ibbb2",R.drawable.ibbb2,R.drawable.inglocaptura));

        aniadirEntrada(new Peliculax("8","DJANGO\n" +
                ...
                "CURIOSIDADES:\n" +
                "\n" +
                "ºº La escena del Klu Klux Klan, liderado por Don Johnson, en la que discuten sobre esas caperuzas tejidas a mano, esconde dos guiños. El primero es El nacimiento de una nación, filme de D. W. Griffith en la que los miembros del Klan protagonizan una épica cabalgata. El segundo, más cariñoso, tiene por objeto el Django original de Sergio Corbucci: resulta que, en dicha película, el pistolero Nero lucha contra el Klu Klux Klan cuyos miembros lucen unas capuchas con aberturas para los ojos muy, muy pequeñas. Tanto, que los fans del spaghetti western aún discuten sobre cómo podían ver con ellas puestas.\n" +
                "\n" +
                "ºº Muchos han visto en la escena de las pistolas diminutas escondidas en las mangas de Schultz un homenaje a Taxi Driver pero parece que es otra película la que se esconde en estas imágenes: la referencia va destinada a Sartana, un ,pistolero protagonista de varios spaghetti westerns que se valía de gadgets y máquinas de todo tipo para acabar con los malos, incluyendo los famosos resortes en las muñecas. Por cierto, en la saga también hubo lugar para un Django desafía a Sartana.\n" +
                "\n" +
                "ºº King Schultz se sorprende del nombre de la amada de Djanjo (¨¿Me estás diciendo que tu mujer se llama Broomhilda Von Shaft?¨) , y desde luego no es casual. Según ha dejado caer el director, entre los futuros descendientes de su héroe y su heroína se encontrará John Shaft, el detective negro y cabreado al que Richard Roundtree encarnó en Las noches rojas de Harlem y Shaft en África.\n" +
                "\n" +
                "ºº El personaje interpretado en Django por el gran Christoph Waltz se hace llamar ¨Dr. King Schultz¨." +
                " Este apellido debe resultar familiar a cualquier conocedor de la obra de Tarantino. En Kill Bill Vol.2 había un episodio titulado ¨La solitaria tumba de Paula Schultz¨ . Por la fecha de nacimiento de Paula Schutz que puede verse en la película (1827) y sabiendo que Django se ambienta en 1858, no cabe duda que existe algún tipo de relación en la mente del director\n","drawable/djangobb2",R.drawable.djangobb2,R.drawable.djangocaptura));

        aniadirEntrada(new Peliculax("9","THE HATEFUL EIGHT ","2015","CASTING:\n" +"\n" +"# Samuel L. Jackson - Mayor Marquis Warren.\n" +
                ...
                "\n" +
                "CURIOSIDADES:\n" +"\n" +
                "ºº Luego de que alguien filtrara el guión en internet, Quentin Tarantino había cancelado los planes de realizar esta película. Pero después de que se realizó una lectura del guion en Los Ángeles, el elenco estaba tan asombrado, que Samuel L. Jackson persuadió a Tarantino para que aceptara filmar la película.\n" +
                "\n" +
                "ºº Quentin Tarantino ha dicho que algunas pistas del soundtrack de Ennio Morriconepara Los Ocho Más Odiados, son pistas que nunca se llegaron a usar para la película de La Cosa (1982).\n" +
                "\n" +
                "ºº A pesar de que es su sexta colaboración como actor y director, esta es la primera vez que Samuel L. Jackson encabeza el reparto en una película dirigida por Quentin Tarantino.\n" +
                "ºº Esta es la tercera película consecutiva de Quentin Tarantino en la que un personaje recibe un balazo en los testículos.\n","drawable/hebb2",R.drawable.hebb2,R.drawable.heightcaptura));
    }
     ...
     *
     * @param peliculax Elemento que añadimos a la lista
     */
    private static void aniadirEntrada(Peliculax peliculax) {
        ENTRADAS_LISTA.add(peliculax);
        ENTRADAS_LISTA_HASHMAP.put(String.valueOf(peliculax.id), peliculax);
    }
    ...
    public static  class Peliculax {
        ...
        public String img;
        public int imgdetalle;
        public int imgcaptura;

        public Peliculax() {
        }

        public Peliculax(String id, String nombre, String fecha, String cast, String sinopsis, String img, int imgdetalle, int imgcaptura) {
            this.id = id;
            this.nombre = nombre;
            this.fecha = fecha;
            this.cast = cast;
